...
export function listingToFormValues(listing: ListingDTO): IListingForm {
  return {
    ...
    areaWidth: listing.areaWidth,
    areaLength: listing.areaLength,
    totalArea: listing.totalArea,
    numRooms: listing.numRooms || undefined,
    numBathrooms: listing.numBathrooms || undefined,
    numFloors: listing.numFloors || undefined,
    ...
    frontageType: (listing.frontageType ?? undefined) as IListingForm["frontageType"],
    legalStatus: (listing.legalStatus ?? undefined) as IListingForm["legalStatus"],
    direction: (listing.direction ?? undefined) as IListingForm["direction"],
    roadWidth: listing.roadWidth ?? undefined,
