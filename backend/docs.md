...
### Enums
TransactionType = [SANG_NHUONG, CHO_THUE, BAN]
PropertyType = [NHA_PHO, CAN_HO, CHDV, DAT, BIET_THU, VAN_PHONG, MAT_BANG, KHO_XUONG, NHA_TRO, KHAC]
CommissionType = [PERCENTAGE, FLAT]
DirectionType = [DONG, TAY, NAM, BAC, DONG_BAC, DONG_NAM, TAY_BAC, TAY_NAM]
Tag = [moi_nhat, ban_chay, noi_bat]
Status = [draff, post_pending, edit_pending, deposite_pending, soldout_pending, complete_pending, available, deposited, soldout, expired, completed]
Action = [submit, withdraw, deposit, soldout, cancel, complete]
NotificationType = [request_edit, request_post, request_deposite, request_soldout, request_cancel, request_complete]
ReleaseType = [request_post, request_edit, request_deposite, request_soldout, request_cancel, request_complete]
...
FileInfo = {
	...
	mimetype: string
	created_by: UUID
	entity_type: 'review' | 'property' | 'avatar'
	size: number
}
...
CompleteRequest = DepositeRequest

Approval = {
	id: UUID
	approval_type: ReleaseType
...
ApprovalListParams = { release_types: ReleaseType[] | null, status: ApprovalStatus[] | null } & PropertyFilterRequest
...
CreateOrganizationRequest = { name: string, display_name: string }
UpdateOrganizationRequest = { name: string | null, display_name: string | null }

### Response types

# Auth
LoginResponse = { access_token: string, token_type: 'bearer', user: User }
...
DealEventInfo = { id: UUID, property_id: UUID, event_type: string, reported_by_id: UUID, confirmed_by_id: UUID | null, confirmed_at: Date | null, notes: string | null, customer_name: string | null, customer_phone: string | null, created_at: Date }
StatusLogResponse = [StatusLogEntry]
DealEventResponse = [DealEventInfo]
...
ApprovalCountsResponse = { [ReleaseType]: number }
...
GET /listings/{listing_id} Get
PUT /listings/{listing_id} Update
DELETE /listings/{listing_id} Delete

POST /listings/{listing_id}/submit Submit
POST /listings/{listing_id}/withdraw Withdraw
POST /listings/{listing_id}/deal-events/deposit Deposit
POST /listings/{listing_id}/deal-events/closure Closure
POST /listings/{listing_id}/deal-events/cancellation Cancellation
POST /listings/{listing_id}/deal-events/sold-out Sold Out
...
- Soft delete for: deposite_pending, deposited, soldout_pending, soldout, expired, complete_pending, completed
...
- When Request User is
  - Sale:
    - Change status to deposite_pending
    - Send notification (request_deposite) to admin/approver
  - Admin, Approver:
    - Change status to deposited
Request: DepositeRequest
Response: PropertyResponse
...
GET /properties/{id}/deal-events
Desc: Get deal events for a property
Rules: Owner, admin, approver
Response: DealEventResponse
...
### Deprecated
PUT /listings/{listing_id}/pin Pin
DELETE /listings/{listing_id}/pin Unpin
...
### Deprecated:
GET /approvals/queues Queues
GET /approvals/queues/{queue_type} Queue Items
GET /approvals/{listing_id} Detail
POST /approvals/{listing_id}/approve Approve
POST /approvals/{listing_id}/reject Reject
...
### Deprecated
POST /listings/{listing_id}/reviews/{review_id}/images
POST /listings/{listing_id}/images
PUT /listings/{listing_id}/images/reorder
DELETE /listings/{listing_id}/images/{image_id}
PUT /listings/{listing_id}/images/{image_id}/primary
...
### Deprecated
GET /listings/{id}/reviews ListAll
POST /listings/{id}/reviews Create
GET /listings/{id}/reviews/{review_id} Get
...
## Users
Prefix: `/users`
Rules: All endpoints require ADMIN role unless noted
